...
export default function MolinoBranch() {
  return (
    <>
    <NavbarMUI /> 
    <Box>
...
<Typography variant="h3" sx={{ px:10, py:10 }} color={"palevioletred"}>Molino Branch</Typography>
...
<Stack  direction="row" sx={{ px:10 }} >
        ...
        <Grid item  sm={12} md={6} lg={6}>
          <ImageList sx={{ width: 700, height: 950 }} variant="woven" cols={3} gap={8}>
            ...
            <Grid item  sm={12} md={6} lg={6}>
                <img src={molino} className="img1" alt="post"></img>
            </Grid>
